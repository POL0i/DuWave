...
class DesktopLibraryPlatformHelper(private val prefs: AppPreferences, private val scanner: ILibraryScanner? = null) : ILibraryPlatformHelper {
    ...
    override fun getLocalizedString(key: String, vararg formatArgs: Any): String {
        ...
        val template = when (key) {
            ...
            "style_classic" -> if (lang == "en") "Classic" else if (lang == "pt") "Clássico" else "Clásico"
            "style_cyberpunk" -> if (lang == "en") "Cyberpunk" else if (lang == "pt") "Cyberpunk" else "Cyberpunk"
            "style_anime" -> if (lang == "en") "Pastel Anime" else if (lang == "pt") "Anime Pastel" else "Anime Pastel"
            "style_luminous" -> if (lang == "en") "Luminous" else if (lang == "pt") "Luminoso" else "Luminoso"
            "style_kawaii" -> if (lang == "en") "Kawaii" else if (lang == "pt") "Kawaii" else "Kawaii"
            "style_black_metal" -> if (lang == "en") "Black Metal" else if (lang == "pt") "Black Metal" else "Black Metal"
            "style_dark_fantasy" -> if (lang == "en") "Dark Fantasy" else if (lang == "pt") "Dark Fantasy" else "Dark Fantasy"
            "style_cathedral" -> if (lang == "en") "Cathedral" else if (lang == "pt") "Catedral" else "Catedral"
            "style_hearts" -> if (lang == "en") "Hearts" else if (lang == "pt") "Corações" else "Corazones"
            "style_tale_legend" -> if (lang == "en") "Fairy Tale" else if (lang == "pt") "Lenda e Conto" else "Leyenda Cuento"
