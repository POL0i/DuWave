...
fun AdvancedSleepTimerDialog(
    ...
    AlertDialog(
        ...
        title = { Text(getLocalizedString("exact_timer"), color = colorVibrant) },
        text = {
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceEvenly) {
                    TextButton(onClick = { onSetSleepTimer(0) }) {
                        Text(getLocalizedString("turn_off"), color = colorVibrant)
                    }
        ...
        confirmButton = {
            TextButton(onClick = onDismiss) { Text(getLocalizedString("close"), color = colorVibrant) }
        },
